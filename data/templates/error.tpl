            ...
            <div class="col-md-6">
                <div class="card mt-5 mb-5">
                    <div class="card-header">
                        <h5 style="margin-bottom: 0px;font-weight: bold;">{{title}}</h5>
                    </div>
                    <div class="card-body">
                        <p>{{description}}</p>
                    </div>
                    <div class="card-footer">
                        <a href="javascript:location.href=location.href;"><button
                                class="btn btn-primary btn-sm btn-block">刷新</button></a>
                    </div>
                </div>
            </div>
        </div>
